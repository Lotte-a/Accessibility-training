...
export default function Labels() {
	...
	return (
		<div className="wrapper">
			<Helmet>
                <title>Quiz labels | Accessibility Training</title>
            </Helmet>

			<Row>
				<div className="wrapper__introduction hidden-hover col-lg-6 col-sm-12 col-xs-12">

					<h1 className="u-text-title">Labels</h1>
			...
			{showScore ? (
				<Row>
					...
					<div className="col-lg-6 col-sm-12 col-xs-12">
						<h2 className="u-text-title">Afgeronde onderdelen (5/7)</h2>
						...
						<div className="btn-action">
							<Link to="/buttons"><Button>Naar het volgende onderdeel</Button></Link>
						</div>
					</div>
				</Row>
			) : null}
